...
class App(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.lw_movies.setSelectionMode(QtWidgets.QListWidget.ExtendedSelection) #permet de selectionner plusieurs
        # film d'un coup
    ...
    def afficher_movies(self):
        movies = get_movies()
        for movie in movies:
            lw_item = QtWidgets.QListWidgetItem(movie.title) #cela nous permettre de selectionner plusieurs titres
